...
get_current_time = lambda action: time.strftime("%H:%M:%S", time.localtime(time.time() + 16*3600 - 28*60)) if action else time.strftime("%H:%M:%S", time.localtime(time.time()))
get_current_dayofweek = lambda action: time.strftime("%A", time.localtime(time.time() + 16*3600 - 28*60)) if action else time.strftime("%A", time.localtime(time.time()))
